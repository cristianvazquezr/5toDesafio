...
class userMananger{
    ...
    async addUser(first_name,last_name, email, age, password,admin){
        ...
        let user1= {first_name:first_name,last_name:last_name,email:email,age:age,password:password,admin:admin}
    ...
    async login(user, pass){
        const listaUser=await userModel.findOne({$and:[{email:user},{password:pass}]}).lean() || null
        return listaUser
    }
